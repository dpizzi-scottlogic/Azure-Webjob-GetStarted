...
namespace WebRole1.Controllers
{
    public class AdController : Controller
    {
        ...
        {
            InitializeStorage();
            db = new ContosoAdsContext(RoleEnvironment.GetConfigurationSettingValue(MvcApplication.AdsConnectionKey));
        }

        private void InitializeStorage()
        {
            // Open storage account using credentials from .cscfg file.
            var storageAccount = CloudStorageAccount.Parse(RoleEnvironment.GetConfigurationSettingValue(MvcApplication.storageConnectionKey));
            ...
            thumbnailRequestQueue = queueClient.GetQueueReference(MvcApplication.queueKey);
